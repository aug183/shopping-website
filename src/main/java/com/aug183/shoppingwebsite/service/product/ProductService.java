...
import com.aug183.shoppingwebsite.exception.ProductNotFoundException;
...
import com.aug183.shoppingwebsite.repository.ProductRepository;
...
public class ProductService implements IProductService {
    ...
    public Product addProduct(AddProductRequest request) {
        ...
        // if exists, set it as the new product category
        // if not, create the category then assign to the new product
